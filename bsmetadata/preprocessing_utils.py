...
class EntityPreprocessor(
    ...
    def __init__(
        self,
        base_url,
        max_num_chars=None,  # default length of text set as threshold to include an example in a batch
    ...
    def preprocess_example(self, examples: Dict[str, List]) -> Dict[str, List]:
        # preprocess all the examples in a particular batch in the required format and consider an example only if 
        # length of text is less than or equal to max_num_chars
        processed = {
            ex_id: [ex_text, []]
